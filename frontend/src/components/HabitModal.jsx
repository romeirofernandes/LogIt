        ...
        >
          <div>
            ...
            <motion.input
              ...
              className="w-full px-3 py-2 bg-white dark:bg-zinc-800 border border-zinc-300 dark:border-zinc-600 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#1995ad] focus:border-transparent"
              required
          ...
          <div>
            ...
            <motion.textarea
              ...
              rows={3}
              className="w-full px-3 py-2 bg-white dark:bg-zinc-800 border border-zinc-300 dark:border-zinc-600 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#1995ad] focus:border-transparent resize-none"
              whileFocus={{ scale: 1.02 }}
              transition={{ duration: 0.2 }}
            />
          </div>
